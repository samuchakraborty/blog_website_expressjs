...
app.get('/post/:postId', function (req, res) {
  ...
  //  console.log(postArray[0]['title']);

  //var check = _.lowerCase(req.params.postId);
  const requireId = (req.params.postId);
  Post.findOne({ _id: requireId }, function (err, postid) {

    console.log(postid);
    res.render('post', { post: { tit: postid.titleOfContent, des: postid.content } });
   });
